...
uploadForm.onsubmit = function(event) {
    ...
    if (file && dishName) {
        ...
        reader.onload = function(e) {
            ...
            img.classList.add('borc'); // добавляем класс для стилей
            
            const name = document.createElement('p');
            name.textContent = dishName;
            name.classList.add('bor'); // добавляем класс для стилей
            ...
            link.onclick = function() {
                addToCart(dishName, 0); // Добавьте здесь логику для добавления в корзину
            };
            ...
            mainContainer.insertBefore(newSoup, addBlock);
